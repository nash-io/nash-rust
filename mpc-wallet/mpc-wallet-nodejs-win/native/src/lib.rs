...
export! {
    ...
    fn compute_presig_ecdsa(api_childkey_str: String, msg_hash_str: String, curve: common::Curve) -> String {
...
#[cfg(test)]
mod tests {
    use crate::{compute_presig_ecdsa, dh_init, fill_rpool, get_rpool_size, sign};
