...
/// Input: api_childkey: API childkey struct, msg_hash: message hash in case of ECDSA or full message in case of EdDSA, curve: Secp256k1, Secp256r1, or Curve25519
