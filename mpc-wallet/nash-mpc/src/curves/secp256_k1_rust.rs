...
impl ECScalar<Scalar> for Secp256k1Scalar {
    ...
    fn add(&self, other: &Scalar) -> Result<Secp256k1Scalar, NashMPCError> {
    ...
    fn mul(&self, other: &Scalar) -> Result<Secp256k1Scalar, NashMPCError> {
        let res = self.fe * other;
        if bool::from(res.is_zero()) {
            return Err(NashMPCError::ScalarInvalid);
        }
    ...
    fn sub(&self, other: &Scalar) -> Result<Secp256k1Scalar, NashMPCError> {
        let res = self.fe - other;
        if bool::from(res.is_zero()) {
            return Err(NashMPCError::ScalarInvalid);
        }
...
impl Sub<Secp256k1Scalar> for Secp256k1Scalar {
    type Output = Result<Secp256k1Scalar, NashMPCError>;
    fn sub(self, other: Secp256k1Scalar) -> Result<Secp256k1Scalar, NashMPCError> {
        (&self).sub(&other.fe)
    }
}
...
impl<'o> Sub<&'o Secp256k1Scalar> for Secp256k1Scalar {
    type Output = Result<Secp256k1Scalar, NashMPCError>;
    fn sub(self, other: &'o Secp256k1Scalar) -> Result<Secp256k1Scalar, NashMPCError> {
        (&self).sub(&other.fe)
    }
}
...
impl ECPoint<VerifyingKey, Scalar> for Secp256k1Point {
    ...
    fn scalar_mul(&self, fe: &Scalar) -> Result<Secp256k1Point, NashMPCError> {
...
impl Sub<Secp256k1Point> for Secp256k1Point {
    type Output = Result<Secp256k1Point, NashMPCError>;
    fn sub(self, other: Secp256k1Point) -> Result<Secp256k1Point, NashMPCError> {
...
impl<'o> Sub<&'o Secp256k1Point> for Secp256k1Point {
    type Output = Result<Secp256k1Point, NashMPCError>;
    fn sub(self, other: &'o Secp256k1Point) -> Result<Secp256k1Point, NashMPCError> {
        self.sub_point(&other.ge)
    }
}
