use super::types::LimitOrderResponse;
use crate::graphql::place_limit_order;
use crate::types::{BuyOrSell, OrderStatus, OrderType};
use chrono::{DateTime, Utc};
use std::str::FromStr;

impl From<place_limit_order::ResponseData> for LimitOrderResponse {
    fn from(response: place_limit_order::ResponseData) -> Self {
        ...
        Self {
            ...
            placed_at: DateTime::<Utc>::from_str(&response.placed_at)
                .expect("ME returned invalid placed_at DateTime for LimitOrderResponse"),
