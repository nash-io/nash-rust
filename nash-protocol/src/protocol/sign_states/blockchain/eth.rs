...
use crate::types::blockchain::{Prefix, eth::Address};
...
mod tests {
    ...
    #[test]
    fn test_new_payload(){
        let state_update = StateUpdatePayloadEth::from_hex("00000e000000000000f02c00000755cfe0b67c5ac477191cc1bae28f1f7b016027be20").unwrap();
    }
